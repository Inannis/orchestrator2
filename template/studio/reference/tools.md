...
- **Seeing a live web page.** `python "C:/Users/johan/Desktop/Git Projects/orchestrator2/tools/shot.py" <url> out.png [--full] [--width 1200]` screenshots any live URL with a real headless browser (Playwright/Chromium), including your own public page. Then open the PNG. It cannot pass the Art Institute's human-verification wall; those images stay unavailable.
